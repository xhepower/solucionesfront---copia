  ...
  const findByTitle = () => {
    if (searchValue == "") {
      ...
      if (searchValue.length < 3) {
        ...
        EgresoService.findByTitle(searchValue)
          .then((response) => {
            setEgresos(response.data);
            //console.log(response.data);
          })
    ...
    <>
      ...
      <div className="container-fluid ">
        <div className="row align-items-center">
          <h2 className="col-10">Lista de egresos</h2>
          <div className="col-2 justify-items-end">
            <a className="btn btn-primary" href="/addegreso">
              {"Agregar Egreso "}
            </a>
          </div>
        </div>
      ...
      <div className="container">
        <List data={egresos} pageLimit={5} pageNeighbours={1}></List>
      </div>
    </>
  );
}
